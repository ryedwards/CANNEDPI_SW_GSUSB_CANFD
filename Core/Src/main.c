...
#define SYSMEM_RESET_VECTOR            0x1FF09800
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, LED1_Pin|LED2_Pin|LED3_Pin|FDCAN1_TERM_EN_Pin
                          |FDCAN2_TERM_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED1_Pin LED2_Pin LED3_Pin FDCAN1_TERM_EN_Pin
                           FDCAN2_TERM_EN_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|LED3_Pin|FDCAN1_TERM_EN_Pin
                          |FDCAN2_TERM_EN_Pin;
